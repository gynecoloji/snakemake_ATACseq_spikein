...
-------------------------------
By default the kept set is read from `keep_chroms` in ref/config.yaml (so the
...
def main(argv):
    ...
    ap.add_argument("--config", default="ref/config.yaml",
                    help="config YAML providing the default keep_chroms (default: ref/config.yaml)")
